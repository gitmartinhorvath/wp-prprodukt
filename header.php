                    ...
                    <div class="container"> 
                        <div class="row align-items-center"> 
                            ...
                            <div class="col-lg-4 col-md-4 col-12"> 
                                ...
                                <ul class="user-login"> 
                                    <li> 
                                        <a href="https://www.proprodukt.sk/index.php/my-account/"><?php _e( 'Prihlásenie', 'proprodukt' ); ?></a> 
                                    </li>                                     
                                    <li> 
                                        <a href="https://www.proprodukt.sk/index.php/my-account/"><?php _e( 'Registrovať sa', 'proprodukt' ); ?> </a> 
                                    </li>                                     
                                </ul>                                 
                            </div>                             
                            <!--End: Hard Wp -->                             
                        ...
                        <div class="nav-inner"> 
                            ...
                            <div class="mega-category-menu"> 
                                ...
                                <ul class="sub-category"> 
                                    <li>
                                        <a href="https://www.proprodukt.sk/index.php/product-category/cistaca/"><?php _e( 'Čistiaca technika', 'proprodukt' ); ?></a>
                                    </li>                                     
                                    <li>
