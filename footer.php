                        ...
                        <div class="row"> 
                            <div class="col-lg-3 col-md-4 col-12"> 
                                <div class="footer-logo"> 
                                    <a href="https://www.proprodukt.sk/"> <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo/LOGO_PROPRODUKT_footer.svg" alt="#"> </a> 
                                </div>                                 
                            </div>                             
                            ...
                            <div class="col-lg-3 col-md-6 col-12"> 
                                ...
                                <div class="single-footer f-link"> 
                                    ...
                                    <h3>Všeobené informácie</h3> 
                                     ...
                                     <ul>
                                        <li><a href="https://www.proprodukt.sk/index.php/garancia-vratenia-penazi/">Garancia vrátenia peňazí</a></li>
                                        <li><a href="https://www.proprodukt.sk/index.php/obchodne-podmienky/">Obchodné podmienky</a></li>
                            ...
                            <div class="col-lg-3 col-md-6 col-12"> 
                                ...
                                <div class="single-footer f-link"> 
                                    ...
                                    <h3>Môj účet</h3> 
                                     ...
                                     <ul>
                                        <li><a href="https://www.proprodukt.sk/index.php/my-account/orders/">Objednávky</a></li>
                                        <li><a href="https://www.proprodukt.sk/index.php/my-account/edit-account/">Detaily účtu</a></li>
                                        <li><a href="https://www.proprodukt.sk/index.php/my-account/">Zabudnuté heslo</a></li>
                                    </ul>
                                </div>                                 
                                <!-- End Single Widget -->                                 
                            </div>                             
